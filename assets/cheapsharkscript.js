...
let gameID = ""
console.log("Steam is :" + csStores[0].storeName)
console.log("Steam Banner is :" + csStores[0].images.banner)
var dealsArr = []
  ...
  fetch('https://cheapshark-game-deals.p.rapidapi.com/games?id=' + value, requestOptions)
    ...
    .then(function (data) {
      ...
      for (let zx = 0; zx < dealsArr.length; zx++) {
        ...
        dealSPrice.textContent = "Current Price: $" + dealsArr[zx].price
        ...
        dealDiv.append(storeBanner, dealSPrice, dealOPrice, buyBtn)
      }
    });
